...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private void initView() {
        ...
        loadmore_view = findViewById(R.id.loadmore_view_layout);
        emptyView = findViewById(R.id.loadmore_view_empty);

    }

    public void toogleLayout(boolean isEmpty) {
        if (isEmpty) {
            loadmore_view.setVisibility(GONE);
            emptyView.setVisibility(View.VISIBLE);
        } else {
            emptyView.setVisibility(View.GONE);
            loadmore_view.setVisibility(VISIBLE);
        }
    }
