...
public class ChangeInfoGridPicAdapter extends BaseAdapter {
    private List<String> mUI;
    private Context context;
    private LayoutInflater mLayoutInflater;

    public ChangeInfoGridPicAdapter(List<String> ui, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mLayoutInflater.inflate(R.layout.change_img_item,
                    parent, false);
