...
public class MeStarChangeAdapter extends BaseAdapter {
    ...
    public MeStarChangeAdapter(final Context _context, List<MeStarChange.Datas> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Button initate_unchange=ViewHolder.get(convertView, R.id.initate_unchange);
        ...
        if ("0".equals(meInitateActivity.getStatus())) {
            initate_status.setVisibility(View.GONE);
            initate_unchange.setVisibility(View.GONE);
        } else if ("1".equals(meInitateActivity.getStatus())) {
            initate_status.setSelected(false);//true是灰色
            initate_status.setText("确认置换");
            initate_status.setEnabled(true);
            initate_status.setVisibility(View.VISIBLE);
